...
export default function SellPage() {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-b from-[#f8f9fa] to-[#efefef] ${isRTL ? 'rtl' : 'ltr'}`}>
      <Navbar />

      {/* Header Section */}
      <section className="bg-gradient-to-br from-[#1e1e1e] via-[#2d2d2d] to-[#1e1e1e] text-white py-16">
      ...
      <section className="py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {/* Step 1 */}
            <div className={`bg-white rounded-2xl p-6 shadow-md transition-all duration-300 ${currentStep === 1 ? 'ring-4 ring-[#f0cb8e] shadow-xl transform scale-105' : 'hover:shadow-lg'}`}>
              <div className="flex items-center gap-4 mb-4">
                <div className={`w-16 h-16 rounded-full flex items-center justify-center text-white text-2xl font-bold transition-all duration-300 ${currentStep === 1 ? 'bg-[#f0cb8e] scale-110' : 'bg-blue-600'}`}>
                  1
                </div>
                <div className={`font-semibold transition-colors ${currentStep === 1 ? 'text-[#f0cb8e]' : 'text-blue-600'}`}>
                  {t(translations.step)}
                </div>
              </div>
            ...
            {/* Step 2 */}
            <div className={`bg-white rounded-2xl p-6 shadow-md transition-all duration-300 ${currentStep === 2 ? 'ring-4 ring-[#f0cb8e] shadow-xl transform scale-105' : 'hover:shadow-lg'}`}>
              <div className="flex items-center gap-4 mb-4">
                <div className={`w-16 h-16 rounded-full flex items-center justify-center text-white text-2xl font-bold transition-all duration-300 ${currentStep === 2 ? 'bg-[#f0cb8e] scale-110' : 'bg-blue-600'}`}>
                  2
                </div>
                <div className={`font-semibold transition-colors ${currentStep === 2 ? 'text-[#f0cb8e]' : 'text-blue-600'}`}>
                  {t(translations.step)}
                </div>
              </div>
              <h3 className="text-xl font-bold text-[#1e1e1e] mb-2">
            ...
            {/* Step 3 */}
            <div className={`bg-white rounded-2xl p-6 shadow-md transition-all duration-300 ${currentStep === 3 ? 'ring-4 ring-[#f0cb8e] shadow-xl transform scale-105' : 'hover:shadow-lg'}`}>
              <div className="flex items-center gap-4 mb-4">
                <div className={`w-16 h-16 rounded-full flex items-center justify-center text-white text-2xl font-bold transition-all duration-300 ${currentStep === 3 ? 'bg-[#f0cb8e] scale-110' : 'bg-blue-600'}`}>
                  3
                </div>
                <div className={`font-semibold transition-colors ${currentStep === 3 ? 'text-[#f0cb8e]' : 'text-blue-600'}`}>
                  {t(translations.step)}
                </div>
              </div>
              <h3 className="text-xl font-bold text-[#1e1e1e] mb-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-[#f0cb8e] focus:border-[#f0cb8e] text-[#1e1e1e] bg-white transition-all duration-200"
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <select
                      ...
                      className="px-3 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-[#f0cb8e] focus:border-[#f0cb8e] bg-white text-[#1e1e1e] transition-all duration-200"
                    >
                      {phoneCodes.map((item) => (
                    ...
                    <input
                      ...
                      required
                      className="flex-1 px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-[#f0cb8e] focus:border-[#f0cb8e] text-[#1e1e1e] bg-white transition-all duration-200"
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-[#f0cb8e] focus:border-[#f0cb8e] text-[#1e1e1e] bg-white disabled:bg-gray-100 disabled:cursor-not-allowed transition-all duration-200"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-[#f0cb8e] focus:border-[#f0cb8e] text-[#1e1e1e] bg-white resize-none transition-all duration-200"
              ...
              <div className="flex justify-center pt-4">
                <Button 
                  type="submit" 
                  size="lg" 
                  className="px-16 py-4 text-lg font-semibold bg-gradient-to-r from-[#f0cb8e] to-[#d8b280] hover:from-[#d8b280] hover:to-[#f0cb8e] transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
                >
