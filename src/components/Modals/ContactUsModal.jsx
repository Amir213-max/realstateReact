          ...
          <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                rows={5}
                className="w-full px-4 py-3 sm:py-3.5 border border-borderColor-strong rounded-xl focus:ring-2 focus:ring-gold focus:border-transparent text-textPrimary text-base sm:text-lg resize-none transition-all duration-200"
                required
              />
            </div>
