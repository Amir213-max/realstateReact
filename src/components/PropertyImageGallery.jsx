...
export default function PropertyImageGallery({ images, propertyName }) {
  ...
  if (!images || images.length === 0) {
    return (
      <div className="relative w-full h-96 bg-gradient-to-br from-bgSection to-borderColor-strong rounded-2xl flex items-center justify-center">
              ...
              <div
                className={`relative w-24 h-24 md:w-28 md:h-28 rounded-xl overflow-hidden border-2 transition-all duration-300 ${
                  activeIndex === index
                    ...
                    : 'border-transparent hover:border-borderColor-strong opacity-70 hover:opacity-100'
                }`}
              >
                <ImageWithLoader
                  src={img}
