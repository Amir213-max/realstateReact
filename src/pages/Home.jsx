      ...
      <BrandAtmosphere className="py-14 sm:py-20">
        <div className="relative z-10 mx-auto max-w-[520px] px-4 sm:px-6 lg:px-8">
          <BrandGlassPanel className="mb-4 flex w-full flex-col items-center gap-2 px-5 py-8 sm:px-8 sm:py-10">
            ...
            <p className="mb-4 max-w-sm text-center text-xs text-textSecondary sm:text-sm">{t(translations.assistanceSubtitle)}</p>
            <a
              href={buildWhatsAppChatUrl(consultantWhatsappDigits, assistanceWhatsAppPrefill)}
              target="_blank"
              rel="noopener noreferrer"
              className="mb-6 flex w-full flex-col gap-2 rounded-xl bg-[#25D366] px-4 py-3.5 text-white shadow-md transition hover:brightness-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-2 sm:flex-row sm:items-center sm:justify-between sm:gap-4"
            >
              ...
              <span className="text-center text-xs font-medium leading-snug text-white/95 sm:max-w-[12rem] sm:text-end">
